    ...
    return (< >
        ...
        <form className="confirmation-form">
            ...
            <div style={{ border: '1px solid wheat', width: '500px', margin: '0 auto', backgroundColor: 'wheat', marginBottom: '1em', textAlign: 'left', paddingLeft: '25%' }}>
                ...
                <div>
                    <label htmlFor="phonenum">Sitting Preference:</label> <span><b>{from.primaryData.preferences}</b></span> <br></br>

                </div>


                <div>
                    <label htmlFor="fName">Name:</label> <span><b>{from.contactData.firstName + " " + from.contactData.lastName}</b></span>
                </div>
